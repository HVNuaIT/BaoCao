    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <c:if test="${sessionScope.acc.isAdmin == 1}">
                    <li class="nav-item">
                        <a class="nav-link" href="loadCa">Quản lí Danh Mục</a>
                    </li>
                </c:if>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Shop Bán Hoa Của Nữa Đẹp Trai </h1>
        <p class="lead text-muted mb-0">Đại Học Gia Định</p>
    </div>
</section>
<!--end of menu-->
